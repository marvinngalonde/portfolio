          ...
          <div className="flex justify-center lg:justify-end">
            <div className="hexagon-container">
              ...
              <div className="hexagon-image">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-08-21%20154752-0LuPCV5c8S9IpB36wHuSChy2ZAWJKv.png"
                  alt="Marvin Ngalonde"
                  width={400}
                  height={400}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="bg-gray-800 border-gray-700 overflow-hidden group hover:border-cyan-400 transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Neocentric Interiors</h3>
            ...
            <Card className="bg-cyan-400 border-cyan-400 overflow-hidden group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-cyan-500"></div>
              <div className="relative z-10 p-8 h-full flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Business Management System</h3>
            ...
            <Card className="bg-gray-800 border-gray-700 overflow-hidden group hover:border-cyan-400 transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Gym Management System</h3>
                <p className="text-gray-400 mb-4">
            ...
            <Card className="bg-gray-800 border-gray-700 overflow-hidden group hover:border-cyan-400 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-4">
                  Various web applications and solutions built for different clients using modern technologies.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex space-x-2">
                    <span className="px-2 py-1 bg-cyan-400/20 text-cyan-400 text-xs rounded">React</span>
            ...
            <Card className="bg-gray-800 border-gray-700 overflow-hidden group hover:border-cyan-400 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-4">
                  Large-scale applications and enterprise solutions for various industries and business needs.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex space-x-2">
                    <span className="px-2 py-1 bg-cyan-400/20 text-cyan-400 text-xs rounded">Full Stack</span>
                    <span className="px-2 py-1 bg-cyan-400/20 text-cyan-400 text-xs rounded">Enterprise</span>
                  </div>
                  <ExternalLink size={20} className="text-gray-400 group-hover:text-cyan-400 transition-colors" />
                </div>
              </div>
